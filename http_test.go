...
func TestFixedResponses(t *testing.T) {
	cases := []struct {
		...
		{"/s/1323e26333e2933323e2631323/_/;/META-INF/maven/com.atlassian.jira/jira-webapp-dist/pom.properties", 200, re("<?xml")},
		...
		{"/_profiler/phpinfo", 200, re(`href="https?://www.php.net/`)},
